import{a as o}from"./chunk-OFCXW7NY.js";import{a as t}from"./chunk-QZIEMCIY.js";function h(){return`
    ...
    `}var u=P;function b(){return this.beforeAppendChild=i=>{let e=i.children[0],n=e.querySelectorAll(".descriptions li.description"),a=e.querySelectorAll(".names li"),v=()=>{n.forEach(s=>s.style.display="none"),a.forEach(s=>s.classList.remove("selected"))};a.forEach((s,f)=>{s.addEventListener("click",()=>{v(),s.classList.add("selected"),n[f].style.display="block",window.scrollTo({top:0,behavior:"smooth"})})})},this.enableSubComponents({ExperienceDescription1:r,ExperienceDescription2:c,ExperienceDescription3:p,ExperienceDescription4:l,ExperienceDescription5:d,ExperienceDescription6:m,ExperienceDescription7:u,Footer:o}),this.goto=()=>{t.dispatch("routing","/index.html")},this.enableEvents(["click"]),`
...
//# sourceMappingURL=Experience-5Y7KHGBU.js.map
